...
- Add **Private** local-GPU node (folder of PDF/text, vault isolation).
- Remove node-builder progress bars, blinking activity dots, and the **Demo activity** toolbar button.
